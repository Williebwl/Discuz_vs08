...
namespace Discuz.Data
{
    public class Users
    {
        ...
        public static int submitlotteryinfo(int userid, string ticketnumber,ref int result) {
           return DatabaseProvider.GetInstance().submitlotteryinfo(userid, ticketnumber,ref result);
        }


        public static DataTable GetUserLotteryList(int pagesize,int pageindex,ref int total) {
            return DatabaseProvider.GetInstance().GetUserLotteryList(pagesize ,pageindex,ref total);

        }

        public static DataTable GetuserRealtimeList()
        {
            return DatabaseProvider.GetInstance().GetuserRealtimeList();
        }
    }
}
