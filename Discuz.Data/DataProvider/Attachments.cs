...
namespace Discuz.Data
{
    ...
    public class Attachments
    {
        ...
        {
            return DatabaseProvider.GetInstance().UpdateAttachmentviewnum(aid);
        }
        ...
        {
            return DatabaseProvider.GetInstance().UpdatePicVote(aid, comment);
        }
        /// <summary>
        /// 更新主题中的附件标志
        /// </summary>
        ...
        /// <param name="type">0：排行(投票数倒序、上传时间倒序排列) 1.投票数量2.最新</param>
        /// <param name="pageIndex"></param>
        /// <param name="pageSize"></param>
        /// <param name="total"></param>
        /// <returns></returns>
        public static DataSet GetVotelist(int aid, string posttitle, int type, int pageIndex, int pageSize, string ordertype, ref int total)
        {
            return DatabaseProvider.GetInstance().GetVotelist(aid, posttitle, type, pageIndex, pageSize, ordertype, ref total);
        }
        ...
        /// <param name="total"></param>
        /// <returns></returns>
        public static DataSet GetVotelistByUid(int aid, int uid, int type, int pageIndex, int pageSize, string ordertype, ref int total)
        {
            return DatabaseProvider.GetInstance().GetVotelistByUid(aid, uid, type, pageIndex, pageSize, ordertype, ref total);
        }
