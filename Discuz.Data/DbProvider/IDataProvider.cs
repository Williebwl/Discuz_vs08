...
namespace Discuz.Data
{
    public partial interface IDataProvider
    {
        ...
        /// </summary>
        /// <param name="aId">附件id</param>
        int UpdateAttachmentviewnum(int aid);
        ...
        /// <returns></returns>
        int UpdatePicVote(int aid, string comment);
        /// <summary>
        /// 更新附件到另一主题
        /// </summary>
        ...
        /// <returns></returns>
        DataSet GetVotelist(int aid, string posttitle, int type, int pageIndex, int pageSize, string ordertype, ref int total);
        /// <summary>
        /// 投票详情图片
        /// </summary>
        /// <param name="aid"></param>
        ...
        /// <param name="total"></param>
        /// <returns></returns>
        DataSet GetVotelistByUid(int aid, int uid, int type, int pageIndex, int pageSize, string ordertype, ref int total);
        /// <summary>
        /// 删除未使用的论坛附件
        /// </summary>
        ...
        /// <returns></returns>
        int submitlotteryinfo(int userid, string ticketnumber, ref int result);

        /// <summary>
        /// 中奖列表
        /// </summary>
        /// <returns></returns>
        DataTable GetUserLotteryList(int pagesize, int pageindex, ref int toal);

        /// <summary>
        /// 实时参与抽奖的用户列表
        /// </summary>
        /// <returns></returns>
        DataTable GetuserRealtimeList();
    }
}
