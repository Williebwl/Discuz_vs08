...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2013-2-28 15:13:13.
		本页面代码由Discuz!NT模板引擎生成于 2013-2-28 15:13:13. 
	*/
	...
	templateBuilder.Append("\r\n                        <option value=\"255\">最高权限</option>\r\n                    </select>\r\n                </em>\r\n                <script type=\"text/javascript\">\r\n                    var topicreadpermclone = $(\"topicreadperm\").cloneNode(true);\r\n                    topicreadpermclone.id = \"topicreadpermclone\";\r\n                    topicreadpermclone.style.display = 'none';\r\n                    document.body.appendChild(topicreadpermclone);       \r\n                    simulateSelect(\"topicreadperm\");\r\n                </");
	templateBuilder.Append("script>\r\n                <img src=\"");
	templateBuilder.Append(forumpath.ToString());
	...
	templateBuilder.Append("\r\n        <select name=\"topicreadpermclone\" id=\"topicreadpermclone\" class=\"ps\" style=\"display:none;\">\r\n            <option value=\"\">不限</option>\r\n            ");
	int userGroupInfo__loop__id=0;
	foreach(UserGroupInfo userGroupInfo in userGroupInfoList)
	{
		userGroupInfo__loop__id++;
