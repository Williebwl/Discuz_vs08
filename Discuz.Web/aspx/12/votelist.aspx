<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.votelist" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2013-3-5 19:55:16.
		本页面代码由Discuz!NT模板引擎生成于 2013-3-5 19:55:16. 
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <strong>投票列表</strong>\r\n    </div>\r\n</div>\r\n<div class=\"wrap cl\">\r\n    <div class=\"main datalist\">\r\n        ");
	if (page_err==0)
	{
	...
	if (Utils.StrToInt(vote["cc"].ToString().Trim(), 0)%4==1)
	{

	templateBuilder.Append("\r\n            <tr>\r\n                ");
	}	//end if

	templateBuilder.Append("\r\n                <td>\r\n                    <img src=\"upload/" + vote["filename"].ToString().Trim() + "\" />\r\n                    <br />\r\n                    票数：" + vote["ticketnum"].ToString().Trim() + " &nbsp;浏览：" + vote["viewnum"].ToString().Trim() + "\r\n                    <br />\r\n                    " + vote["username"].ToString().Trim() + "&nbsp;<input type=\"button\" value=\"投票\" onclick=\"Votepic(" + vote["aid"].ToString().Trim() + "," + vote["uid"].ToString().Trim() + ");\" />\r\n                </td>\r\n                ");
	if (Utils.StrToInt(vote["cc"].ToString().Trim(), 0)%4==0)
	{
