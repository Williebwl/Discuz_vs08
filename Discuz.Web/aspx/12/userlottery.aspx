...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2013-3-6 15:40:17.
		本页面代码由Discuz!NT模板引擎生成于 2013-3-6 15:40:17. 
	*/
	...
	templateBuilder.Append("\" id=\"lsform\" autocomplete=\"off\" method=\"post\">\r\n				<div class=\"fastlg c1\">\r\n					<div class=\"y pns\">\r\n						<p>\r\n							<label for=\"ls_username\">帐号</label> <input type=\"text\" tabindex=\"901\" value=\"用户名/Email\" id=\"ls_username\" name=\"username\" class=\"txt\" onblur=\"if(this.value == '') this.value = '用户名/Email';\" onfocus=\"if(this.value == '用户名/Email') this.value = '';\"/><a href=\"#\" onClick=\"showWindow('register', '");
	templateBuilder.Append(rooturl.ToString());
	...
	templateBuilder.Append("script>\r\n				<div class=\"ptm cl\" style=\"border-top:1px dashed #CDCDCD;\">\r\n					<a class=\"y xg2\" href=\"#\" onclick=\"hideWindow('register');hideWindow('login');showWindow('getpassword', this.href);\">找回密码</a>\r\n					<label class=\"z\" for=\"ls_cookietime\"><input type=\"checkbox\" tabindex=\"906\" value=\"2592000\" id=\"ls_cookietime\" name=\"expires\" checked=\"checked\" tabindex=\"906\"><span title=\"下次访问自动登录\">记住我</span></label>\r\n				</div>\r\n            </div>\r\n			</form>\r\n            ");
	}	//end if
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <strong>抽奖</strong>\r\n	</div>\r\n</div> \r\n");
	if (page_err==0)
	{
	...
	templateBuilder.Append("\r\n<div>\r\n<form method =\"post\">\r\n     <div style=\"width:500px;margin-left:300px\">\r\n          抽奖券号： <input type=\"text\" name=\"ticketnumber\"  onblur=\"checkticketnubmer(this.form)\"/><span style=\"color:Red\" id=\"numbermessage\">*</span> <br /><br />\r\n          手 机 号：  <input type=\"text\" name=\"phone\" onblur =\"checkphone(this.form)\"/><span style=\"color:Red\" id=\"phonemessage\">*</span><br /><br />\r\n        确认手机号：<input type=\"text\" name=\"confirmphone\"  onblur=\"checkconfirmphone(this.form)\"/>\r\n        <span style=\"color:Red;font-size:12\" id=\"confirmphonemessage\">*&nbsp;&nbsp;(该手机号为中奖通知使用,请谨慎填写!)</span><br />\r\n        <input type=\"submit\"  value=\"提交\" onclick=\"return submitLogin(this.form)\"/>\r\n     </div>\r\n </form>\r\n <h3 style=\" margin-left:100px\">中奖名单</h3>\r\n   <table  summary=\"用户列表\" cellspacing=\"0\" cellpadding=\"0\" class=\"datatable\" style =\"margin-left:50px\">\r\n   <thead class=\"colplural\">\r\n     <tr>\r\n        <th width=\"200\">手机号</th>\r\n        <th width=\"200\">券号</th>\r\n        <th width=\"200\">抽奖时间</th>\r\n        <th width=\"200\">奖项名称</th>\r\n     </tr>\r\n     </thead>\r\n     <tbody>\r\n        ");
	int user__loop__id=0;
	foreach(DataRow user in userlotterlist.Rows)
	{
		user__loop__id++;

	templateBuilder.Append("\r\n           <tr>\r\n              ");	string mobile = ForumUtils.ConvertPhone(user["phone"].ToString().Trim());
	
	templateBuilder.Append("	\r\n             <td>");
	templateBuilder.Append(mobile.ToString());
    templateBuilder.Append("</td>\r\n             <td>" + user["ticketnumber"].ToString().Trim() + "</td>\r\n             <td>" + user["lotterdate"].ToString().Trim() + "</td>\r\n             <td>" + user["Grade"].ToString().Trim() + "(" + user["AwardName"].ToString().Trim() + ")</td>\r\n           </tr>\r\n        ");
	}	//end loop
	...
	templateBuilder.Append("\r\n\r\n <script type=\"text/javascript\">\r\n //验证抽奖券号\r\n   function checkticketnubmer(theform){\r\n     var jppattern=/^[A-Za-z0-9]+$/;\r\n     var ticknumber=theform.ticketnumber.value;\r\n     if(!jppattern .test(ticknumber)){\r\n       theform.ticketnumber.value=\"\";\r\n       theform.ticketnumber.focus();\r\n       document.getElementById(\"numbermessage\").innerText=\"只能输入字母和数字\";\r\n     }else if(ticknumber .length>20){\r\n       theform.ticketnumber.value=\"\";\r\n       theform.ticketnumber.focus();\r\n       document.getElementById(\"numbermessage\").innerText=\"券号长度不能大于20\";\r\n     }else {\r\n       document.getElementById(\"numbermessage\").innerText=\"\";\r\n     }\r\n   }\r\n   \r\n   \r\n//手机号码\r\nfunction checkphone(theform) {;\r\n var patrn= /^(13[0-9]|15[0|3|6|7|8|9]|18[7|8|9])\\d{");
	templateBuilder.Append(8.ToString());
	templateBuilder.Append("}$/;\r\n    var phone=theform.phone.value;\r\n    if (!patrn.test(phone)) {\r\n      theform.phone.value=\"\";\r\n      theform.phone.focus();\r\n      document .getElementById (\"phonemessage\").innerText=\"手机号输入有误\";\r\n    }else{\r\n      document .getElementById (\"phonemessage\").innerText=\"\";\r\n    }\r\n   \r\n}\r\n\r\n\r\n//确认手机号\r\nfunction checkconfirmphone(theform){\r\n   var patrn=/^(13[0-9]|15[0|3|6|7|8|9]|18[7|8|9])\\d{");
	templateBuilder.Append(8.ToString());
	templateBuilder.Append("}$/;\r\n   var phone=theform.confirmphone.value;\r\n   if(!patrn.test(phone)){\r\n     theform.confirmphone.value=\"\";\r\n     theform.confirmphone.focus();\r\n     document .getElementById (\"confirmphonemessage\").innerText=\"手机号输入有误\";\r\n    \r\n   } else{\r\n     document .getElementById (\"confirmphonemessage\").innerText=\"\"; \r\n   }\r\n}\r\n\r\n\r\nfunction submitLogin(theform){\r\n   if(theform .ticketnumber.value.length==0){\r\n     document.getElementById(\"numbermessage\").innerText=\"请填写抽奖券号\";\r\n     return false;\r\n   }\r\n   if(theform .phone.value.length==0){\r\n     document .getElementById (\"phonemessage\").innerText=\"请填写手机号\";\r\n     return false;\r\n   }if(theform .confirmphone.length==0){\r\n    document .getElementById (\"confirmphonemessage\").innerText=\"请填写确认手机号\"; \r\n    return false;\r\n   }\r\n   if(theform .phone.value!=theform .confirmphone.value){\r\n      document .getElementById (\"confirmphonemessage\").innerText=\"两次手机号输入不一致\"; \r\n      return false;\r\n   }\r\n     \r\n  }\r\n\r\n</");
	templateBuilder.Append("script>\r\n\r\n");
