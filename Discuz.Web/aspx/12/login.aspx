...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2013-2-28 15:13:14.
		本页面代码由Discuz!NT模板引擎生成于 2013-2-28 15:13:14. 
	*/
	...
	templateBuilder.Append(msgbox_text.ToString());
	templateBuilder.Append("</p>\r\n                <p>\r\n                    点击此处<a href=\"###\" onclick=\"$('emailresetbox').style.display='';\">重新设置/发送E-mail</a>\r\n                    <a href=\"");
	...
	templateBuilder.Append("\r\n                    <a href=\"#\" onclick=\"hideWindow('login');showWindow('register', '");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("register.aspx');\"\r\n                        class=\"xg2\">立即注册</a>\r\n                    ");
	}
	else
	{
	...
	templateBuilder.Append("\r\n                    <a href=\"#\" onclick=\"hideWindow('login');showWindow('getpassword', this.href);\"\r\n                        accesskey=\"g\" title=\"忘记密码 (ALT + G)\" class=\"xg2\">找回密码</a>\r\n                    ");
	}
	else
	{
