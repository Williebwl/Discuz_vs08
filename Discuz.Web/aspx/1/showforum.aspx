...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2013/04/16 17:01:34.
		本页面代码由Discuz!NT模板引擎生成于 2013/04/16 17:01:34. 
	*/
	...
	int dsform__loop__id=0;
	foreach(DataRow dsform in dsForum.Rows)
	{
		dsform__loop__id++;


	if (dsform["ID"].ToString().Trim()==strid)
	{

	 newtopiconclick = "window.location.href ='"+forumpath+"posttopic.aspx?forumid="+forum.Fid+"&forumpage="+pageid+"';";
	
	 intforumid = intforumid+1;
	...
	templateBuilder.Append("\r\n             <!--之前代码注释");	 newtopiconclick = "showWindow('newthread', '" + forumpath + "showforum.aspx?forumid=" + forum.Fid + "')";
	...
	templateBuilder.Append("\r\n        <!--之前代码注释");	 newtopiconclick = "showWindow('login', '" + forumpath + "login.aspx');hideWindow('register');";
	
	templateBuilder.Append("-->\r\n        ");	 newtopiconclick = "window.location.href ='http://www.feipiao.cn/index.php?act=login';";
...
/*特殊帖图标*/
	...
	templateBuilder.Append("\r\n				<div class=\"hm p_login cl\">你需要登录后才可以发帖 <a class=\"xg2\" href=\"");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("login.aspx\">登录</a> | <a class=\"xg2\"  href=\"http://www.feipiao.cn/index.php?act=signup\">注册</a></div>\r\n				");
	}	//end if
