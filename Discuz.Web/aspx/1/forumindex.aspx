...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n                    <li><a href=\"announcement.aspx#" + announcement["id"].ToString().Trim() + "\" class=\"xg2\" title=\"" + announcement["title"].ToString().Trim() + "\">\r\n                        " + announcement["title"].ToString().Trim() + "<em>");
	...
	templateBuilder.Append("\r\n    <div class=\"topic_num cl\">\r\n        <span class=\"y\"><a href=\"showtopiclist.aspx?type=newtopic\" class=\"xg2\">查看新帖</a><span\r\n            class=\"pipe\">|</span> <a href=\"showtopiclist.aspx?type=digest&amp;forums=all\" class=\"xg2\">\r\n                精华区</a>\r\n            ");
	if (config.Rssstatus!=0)
	{

	templateBuilder.Append("\r\n            <a href=\"tools/rss.aspx\" target=\"_blank\">\r\n                <img src=\"");
	templateBuilder.Append(imagedir.ToString());
	...
	templateBuilder.Append("</em><span\r\n                class=\"pipe\">|</span>主题:<em class=\"xg2\">");
	templateBuilder.Append(totaltopic.ToString());
	templateBuilder.Append("</em><span class=\"pipe\">|</span>帖子:<em\r\n                    class=\"xg2\">");
	...
	else
	{
	 ...
	 subcount = subcount+1;
	            ...
	            if (maxsubcount > 0) { if (subcount > maxsubcount) continue; }
	...
	templateBuilder.Append("<p class=\"xg2\">\r\n                            版主: ");
	templateBuilder.Append(forum.Moderators.ToString().Trim());
	templateBuilder.Append("</p>\r\n                        ");
	}	//end if
	...
	templateBuilder.Append("\r\n                            <a href=\"");
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\">\r\n                                ");	templateBuilder.Append(Utils.GetUnicodeSubString(forum.Lasttitle,35,"..."));
	templateBuilder.Append("</a>\r\n                        </p>\r\n                        <div class=\"topicbackwriter\">\r\n                            by\r\n                            ");
	if (forum.Lastposter!="")
	{
	...
	templateBuilder.Append("\r\n                        <p>\r\n                            最后: <a href=\"showtopic.aspx?topicid=");
	templateBuilder.Append(forum.Lasttid.ToString().Trim());
	templateBuilder.Append("&page=end#lastpost\" title=\"");
	templateBuilder.Append(forum.Lasttitle.ToString().Trim());
	templateBuilder.Append("\">\r\n                                <em>");
	...
	templateBuilder.Append("\r\n            <li><a href=\"" + forumlink["url"].ToString().Trim() + "\" target=\"_blank\">\r\n                <img src=\"" + forumlink["logo"].ToString().Trim() + "\" alt=\"" + forumlink["name"].ToString().Trim() + "\" class=\"forumlink_logo\" /></a>\r\n                <h5>\r\n                    <a href=\"" + forumlink["url"].ToString().Trim() + "\" target=\"_blank\">" + forumlink["name"].ToString().Trim() + "</a></h5>\r\n                <p>\r\n                    " + forumlink["note"].ToString().Trim() + "</p>\r\n            </li>\r\n            ");
	}
