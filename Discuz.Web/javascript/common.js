...
function showWindow(k, url, mode, cache, menuv) {
    if(k=="register")
    {
      window.location.href="http://www.feipiao.cn/index.php?act=signup";
    }else if(k=="getpassword")
    {
      window.location.href="http://www.feipiao.cn/index.php?act=login";
    }
    else
    {
	    mode = isUndefined(mode) ? 'get' : mode;
...
function checkvote(){
  ...
  if(vcode==""){
    document.getElementById("sperrormessage").innerText="验证码不正确！";
    return false;
  }
  return true;
}