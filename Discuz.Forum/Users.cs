...
namespace Discuz.Forum
{
    ...
    public class Users
    {
        ...
        /// <param name="tickecnumber"></param>
        public static int submitlotteryinfo(int userid, string tickecnumber,ref int result) {
            return Data.Users.submitlotteryinfo(userid, tickecnumber,ref result);
        }
        ...
        public static DataTable GetUserLotteryList(int pagesize,int pageindex,ref int total) {
            return Data.Users.GetUserLotteryList(pagesize,pageindex,ref total);
        }


        public static DataTable GetuserRealtimeList()
        {
            return Data.Users.GetuserRealtimeList();
        }
