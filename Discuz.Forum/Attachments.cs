...
namespace Discuz.Forum
{
    ...
    public class Attachments
    {
        ...
        /// </summary>
        /// <param name="aId">附件id</param>
        public static int UpdateAttachmentviewnum(int aid)
        {
            if (aid > 0)
        ...
        /// <returns></returns>
        public static int UpdatePicVote(int aid, string comment)
        {
            if (aid > 0)
        ...
        {
            return Data.Attachments.GetVotelist(aid, posttitle, type, pageIndex, pageSize, ordertype, ref total);
        }
        /// <summary>
        /// 投票详情图片
        /// </summary>
        ...
        /// <param name="total"></param>
        /// <returns></returns>
        public static DataSet GetVotelistByUid(int aid, int uid, int pageIndex, int pageSize, ref int total)
        {
            return Data.Attachments.GetVotelistByUid(aid, uid, 1, pageIndex, pageSize, "desc", ref total);
        }
