...
namespace Discuz.Forum
{
    public class CookiesHelper
    {
        ...
        /// <param name="value"></param>
        /// <param name="expires"></param>
        public static void AddNoDomainCoolie(string key, string value, int expires)
        {
        ...
        /// <param name="value"></param>
        /// <param name="expires"></param>
        public static void AddNoDomainCoolie(string cookieName, string key, string value, int expires)
        {
            HttpCookie cookie = new HttpCookie(cookieName);
            if (expires > 0)
            {
        ...
        /// 使无域cookie失效
        /// </summary>
        public static void FailNoDomainCoolie(string cookieName)
        {
        ...
        public static void AddNoDomainCoolie(HttpCookie cookie)
        {
            HttpResponse response = HttpContext.Current.Response;
            if (response != null)
            {
        ...
        /// <param name="value"></param>
        /// <param name="expires"></param>
        public static void AddCookie(string cookieName, string key, string value, int expires)
        {
            HttpCookie cookie = new HttpCookie(cookieName);
            if (expires > 0)
            {
        ...
        public static void AddCookie(HttpCookie cookie)
        {
            ...
            if (response != null)
            {
                ...
                if (cookieDomain != string.Empty && HttpContext.Current.Request.Url.Host.IndexOf(cookieDomain.TrimStart('.')) > -1 && StringClass.IsValidDomain(HttpContext.Current.Request.Url.Host))
                {
        ...
        /// 使cookie失效
        /// </summary>
        public static void FailCookie(string cookieName)
        {
            HttpCookie cookie = CookiesHelper.GetCookie(cookieName);
            if (cookie != null)
            {
        ...
        public static void SetFormsCookie(String userName, String roles)
        {
